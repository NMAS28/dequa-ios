...
struct CourseTwoCards: View {
    ...
    var body: some View {
        VStack{
            ...
            HStack {
                Text("Com base na Declaração Universal dos Direitos Humanos, adotada há 70 anos pela Organização das Nações Unidas (ONU)...").font(.system(size: 18, weight: .medium))
                Spacer()
